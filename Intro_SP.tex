...
The definitions and results that follow should therefore be understood as preparatory
steps toward this fundamental construction. Cylinder sets, consistency conditions, and
regularity assumptions on the state space are introduced precisely to make the
Daniell--Kolmogorov theorem applicable and to ensure that stochastic processes can be
...
\subsection*{Consistency and Marginal Distributions}
...
\subsection*{Why consistency is necessary}
...
\subsection*{Why consistency is sufficient}
...
\section{Inner Regularity and Tightness}
...
\emph{Step 1: Definition of a pre--measure.}
