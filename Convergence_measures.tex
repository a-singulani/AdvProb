...
encode the same information as probabilities of closed (or open) sets. We will be working with the following function classes.
...
rather than all measurable functions. Finally, we can define separating classes.
